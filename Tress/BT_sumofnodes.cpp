...
// int sum; // by default, global variable has zero value
...
int computeSumOfTreeNodes(TreeNode* root) {
	...
	// 1. recursively, compute the sum of nodes in the leftSubtree

	int x = computeSumOfTreeNodes(root->left);

	// 2. recursively, compute the sum of nodes in the rightSubtree
